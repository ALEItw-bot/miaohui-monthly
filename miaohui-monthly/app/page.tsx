    ...
    <>
      ...
      <section className="section" id="events">
        <div className="container">
          ...
          <p className="section-subtitle">即將到來的廠會盛事，千萬別錯過！</p>
      ...
      <section className="section section-dark">
        <div className="container text-center">
          <h2 className="section-title text-white">🏮 廠會月報是什麼？</h2>
      ...
      <section className="section section-cta">
        <div className="container text-center">
          <h2 className="section-title text-white">📥 你也有廠會消息？</h2>
          <p className="cta-text">來當報馬仔！把你知道的廠會情報分享給大家</p>
